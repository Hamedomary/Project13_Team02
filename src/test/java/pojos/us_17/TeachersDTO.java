...
public class TeachersDTO implements Serializable {
	private AdvisorTeacherDTO advisorTeacher;
	...
	private String ssn;
	private List<StudentInfosDTO> studentInfos;
	private String surname;
	private String username;

	public void setAdvisorTeacher(AdvisorTeacherDTO advisorTeacher){
		this.advisorTeacher = advisorTeacher;
	}

	public AdvisorTeacherDTO getAdvisorTeacher(){
	...
	public void setStudentInfos(List<StudentInfosDTO> studentInfos){
		this.studentInfos = studentInfos;
	}

	public List<StudentInfosDTO> getStudentInfos(){
		return studentInfos;
	}

...
public class US15StepDef {
    ...
    public void userEntersViceUsername(String arg0) {
        Driver.getDriver().getTitle().contains("ViceDeanGul");
        us15_Page.userNameVice.sendKeys("ViceDeanGul");
        waitFor(2);
    }

    @And("user enters vice password {string}")
    public void userEntersVicePassword(String arg0) {

        Driver.getDriver().getTitle().contains("Vicedeangul1");
        us15_Page.passwordVice.sendKeys("Vicedeangul1");
        waitFor(2);
    }
    ...
    public void user_enters_student_name(String string) {
        ...
        us15_Page.studentName.sendKeys("Sun");
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_name_box(String string) {
    ...
    public void user_enters_student_surname(String string) {
        ...
        us15_Page.studentSurname.sendKeys("Shine");
        waitFor(2);
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_surname_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
        waitFor(2);
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_birthplace_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
        waitFor(2);
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_phone_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_gender_box(String string) {
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_birthdate__box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_SSN_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_username_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_father_name_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
    }
    ...
    @Then("user verifies that a warning as {string} when you left blank")
    public void user_verifies_that_a_warning_as_when_you_left_blank_mother_name_box(String string) {
        Assert.assertTrue(Driver.getDriver().getTitle().contains("Required"));
        waitFor(2);
    }
    //TC13

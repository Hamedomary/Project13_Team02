...
public class US06_ViceDeanCreation {
    pages.us_06.US06_ViceDeanCreation us06ViceDeanCreation = new pages.us_06.US06_ViceDeanCreation();
...
public void user_enter(String string) {
    ...
    public void user_types_username() {
        WaitUtils.waitFor(1);
       us06ViceDeanCreation.userName.sendKeys("yildizDean");
    }
    @Then("user types password")
    public void user_types_password() {
        us06ViceDeanCreation.password.sendKeys("YildizDean13");
    }
